  ...
  render() {
    return (
      ...
      <div className='row'>
        ...
        <div className='col-lg-4 col-sm-6 text-center mb-4'>
          <img className='rounded-circle img-fluid d-block mx-auto' src='https://avatars3.githubusercontent.com/u/7772230?s=200&v=4' alt='' />
          <h3>Scott Sheppard</h3>
          <p>What does this team member to? Keep it short! This is also a great spot for social links!</p>
        </div>
        <div className='col-lg-4 col-sm-6 text-center mb-4'>
          <img className='rounded-circle img-fluid d-block mx-auto' src='https://avatars1.githubusercontent.com/u/32828225?s=200&v=4' alt='' />
          <h3>Jake Chavez</h3>
          <p>What does this team member to? Keep it short! This is also a great spot for social links!</p>
        </div>
        <div className='col-lg-4 col-sm-6 text-center mb-4'>
